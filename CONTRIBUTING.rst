...
Welcome to ``sphinx-confluencebuilder-extras`` contributor's guide.
...
If you experience bugs or general issues with ``sphinx-confluencebuilder-extras``, please have a look
...
You can help improve ``sphinx-confluencebuilder-extras`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``sphinx-confluencebuilder-extras`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``sphinx-confluencebuilder-extras``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/sphinx-confluencebuilder-extras.git
    cd sphinx-confluencebuilder-extras
...
#. Install |pre-commit|_::
   ...
   ``sphinx-confluencebuilder-extras`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/sphinx-confluencebuilder-extras
.. _issue tracker: https://github.com/<USERNAME>/sphinx-confluencebuilder-extras/issues
.. <-- end -->
